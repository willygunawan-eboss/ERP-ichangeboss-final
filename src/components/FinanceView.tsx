      ...
      <div className="p-8 pb-0">
        <div className="flex justify-between items-end mb-6">
          ...
          <div className="flex gap-3">
            ...
            <button onClick={() => setIsAddModalOpen(true)} className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors shadow-sm shadow-indigo-600/20">
              Record Expense
            </button>
          </div>
        </div>
